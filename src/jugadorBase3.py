...
class JugadorBase3(Jugador):

    def __init__(self):
        Jugador.__init__(self,"JugadorBase3")
    ...
    def determinarPerdida(self,anotacionPosible):
        return {
            'balas': 5 - anotacionPosible[1],
            'tontos': 10 - anotacionPosible[1],
            'trenes': 15 - anotacionPosible[1],
            'cuadras': 20 - anotacionPosible[1],
            'quinas': 25 - anotacionPosible[1],
            'senas': 30 - anotacionPosible[1],
